    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-900 text-white p-6 animate__animated animate__fadeIn">
      <div className="max-w-6xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold animate__animated animate__bounceInDown">
            Get in Touch
          </h1>
          <p className="mt-2 animate__animated animate__fadeIn animate__delay-1s">
        ...
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="md:w-1/2 p-4 animate__animated animate__fadeInLeft">
            <p className="mb-8">
              ...
              support, or just want to share your feedback, please fill out the
              form below to get in touch with us. Our team will respond to your
              message as soon as possible. Thank you for reaching out!
            </p>
            ...
            <div className="mb-6 flex items-center animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <div>
                ...
                <p>Mobile: +91 629931958</p>
                <p>Mail: darshilmahraur@gmail.com</p>
              </div>
            </div>
          ...
          <div className="md:w-1/2 p-4 flex flex-col items-center md:items-end animate__animated animate__fadeInRight">
            <div className="max-w-md w-full">
              <h2 className="text-2xl font-semibold mb-6 text-left md:text-left animate__animated animate__fadeIn animate__delay-1s">
              ...
              <form className="w-full">
                ...
                <button
                  type="submit"
                  className="w-full p-3 rounded bg-blue-600 hover:bg-blue-700 text-white"
                >
                  Send Message
                </button>
              </form>
